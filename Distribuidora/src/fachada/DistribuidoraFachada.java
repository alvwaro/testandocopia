...
public class DistribuidoraFachada {
    ...
    public DistribuidoraFachada() {
        ...
        this.adm = new AuxiliarAdm("adm", 800.00, "Lucas", 35, "12345678901", "879985664",
        ...
        if (this.repFuncionario.buscarPorMatricula("1234") == null) {
            System.out.println("Administrador padrão não encontrado, realizando cadastro inicial...");
            this.repFuncionario.cadastrar(this.adm);
        }
    }
